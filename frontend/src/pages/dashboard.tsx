...
const Dashboard = () => {
  ...
  const [schedules, setSchedules] = React.useState('Loading...');
  const [syllabuses, setSyllabuses] = React.useState('Loading...');
  const [roles, setRoles] = React.useState('Loading...');
  const [permissions, setPermissions] = React.useState('Loading...');
  const [schools, setSchools] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
          ...
          {hasPermission(currentUser, 'READ_SYLLABUSES') && (
          ...
          {hasPermission(currentUser, 'READ_SCHOOLS') && (
            <Link href={'/schools/schools-list'}>
              <div
                className={`${
                  corners !== 'rounded-full' ? corners : 'rounded-3xl'
                } dark:bg-dark-900 ${cardsStyle} dark:border-dark-700 p-6`}
