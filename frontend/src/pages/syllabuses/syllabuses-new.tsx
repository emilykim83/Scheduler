...
import { create } from '../../stores/syllabuses/syllabusesSlice';
...
SyllabusesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SYLLABUSES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default SyllabusesNew;
