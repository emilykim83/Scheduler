...
const ListSyllabuses = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_SYLLABUSES');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/syllabuses/syllabuses-edit/?id=${item.id}`}
                  pathView={`/syllabuses/syllabuses-view/?id=${item.id}`}
