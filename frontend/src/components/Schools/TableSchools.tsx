...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/schools/schoolsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureSchoolsCols';
...
const TableSampleSchools = ({
  ...
  useEffect(() => {
    if (schoolsNotify.showNotification) {
      notify(schoolsNotify.typeNotification, schoolsNotify.textNotification);
    }
  }, [schoolsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/schools/schools-view/?id=${id}`);
  };
...
export default TableSampleSchools;
