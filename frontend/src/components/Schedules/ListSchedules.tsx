...
const ListSchedules = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_SCHEDULES');
              ...
              >
                ...
                >
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>ScheduleName</p>
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/schedules/schedules-edit/?id=${item.id}`}
                  pathView={`/schedules/schedules-view/?id=${item.id}`}
