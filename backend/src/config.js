...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '81ff6799fe6c52a1e2d81129f002c9ba',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Scheduler <app@flatlogic.app>',
  ...
  project_uuid: 'c7e17898-24cc-4f1b-b3fa-c0ebece77301',
  flHost:
...
config.pexelsQuery = 'student studying with books';
config.host =
