...
module.exports = class SchoolsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.users_school = await schools.getUsers_school({
      transaction,
    });

    output.notifications_school = await schools.getNotifications_school({
      transaction,
    });

    output.schedules_school = await schools.getSchedules_school({
      transaction,
    });

    output.syllabuses_school = await schools.getSyllabuses_school({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    let { rows, count } = options?.countOnly
      ...
      : await db.schools.findAndCountAll({
          where: globalAccess ? {} : where,
          include,
          distinct: true,
          limit: limit ? Number(limit) : undefined,
