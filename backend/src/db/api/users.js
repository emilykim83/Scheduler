...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setSchool(data.data.school || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setSchool(data.school || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.schedules_student = await users.getSchedules_student({
      transaction,
    });

    output.syllabuses_student = await users.getSyllabuses_student({
      transaction,
    });
    ...
    output.school = await users.getSchool({
      transaction,
    });
