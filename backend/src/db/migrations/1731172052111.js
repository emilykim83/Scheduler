module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('syllabuses', 'schoolId', {
        transaction,
      });

      await queryInterface.removeColumn('schedules', 'schoolId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('schools', 'name', { transaction });
      ...
      await queryInterface.removeColumn('syllabuses', 'studentId', {
        transaction,
      });

      await queryInterface.removeColumn('syllabuses', 'title', { transaction });

      await queryInterface.removeColumn('schedules', 'studentId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('schedules', 'name', { transaction });

      await queryInterface.removeColumn('notifications', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('notifications', 'send_date', {
        transaction,
      });
      ...
      await queryInterface.dropTable('syllabuses', { transaction });
